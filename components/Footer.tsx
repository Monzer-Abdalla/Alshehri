  ...
  const socialLinks = [
    {
      ...
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.713 5.941zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
        </svg>
      ),
    },
    {
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                dict.footer.links.kitchenAppliances,
                dict.footer.links.homeLighting,
                dict.footer.links.outdoorLighting,
              ].map((item) => (
                <li key={item}>
                  <Link
                    href={`/${lang}/products`}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                dict.footer.links.delivery,
                dict.footer.links.consulting,
                dict.footer.links.maintenance,
              ].map((item) => (
                <li key={item}>
                  <Link
                    href={`/${lang}/contact`}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-zinc-500">{dict.footer.address}</span>
              </li>
