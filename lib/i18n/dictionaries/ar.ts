...
const ar: Dictionary = {
  ...
  cart: {
    title: 'سلة المشتريات',
    emptyMessage: 'سلتك فارغة حالياً',
  ...
  checkout: {
    ...
    successMessage: 'شكراً لتسوقك معنا. سنقوم بمعالجة طلبك قريباً والتواصل معك.',
    cancelTitle: 'تم إلغاء عملية الدفع',
    cancelMessage: 'لم يتم خصم أي مبلغ. يمكنك العودة وإتمام الطلب في أي وقت.',
    backBtn: 'العودة للمتجر',
  },
